...
class TestRectangle_instantiation(unittest.TestCase):
    """Unit tests designed to test the instantiation of the Rectangle class."""
...
class TestRectangle_width(unittest.TestCase):
    """Unit tests designed to test the initialization of the 'width' attribute in the Rectangle class."""
...
class TestRectangle_height(unittest.TestCase):
    """Unit tests designed to test the initialization of the 'height'
...
class TestRectangle_x(unittest.TestCase):
    """Unit tests designed to test the initialization of the 'x' attribute
...
class TestRectangle_y(unittest.TestCase):
    """Unit tests designed to test the initialization of the 'y' attribute
    in the Rectangle class."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unit tests designed to test the order in which attributes are
    initialized in the Rectangle class."""
...
class TestRectangle_area(unittest.TestCase):
    """Unittests specifically designed to test the 'area' method of the
    Rectangle class."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests specifically designed to test the '__str__' and 'display' methods of the Rectangle class."""

    @staticmethod
    def capture_stdout(rect, method):
        """Function that captures and returns text printed to the standard output.

        Args:
        rect ( Rectangle): Rectangle object
        method (str): name `method` to run on `rect`.

        Returns:
        The function returns the text printed to the standard output by
        calling the specified method on the Rectangle object."""
...
class TestRectangle_update_args(unittest.TestCase):
    """Unittests specifically designed to test the 'update' method of the
    Rectangle class when using positional arguments."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittests specifically designed to test the 'update' method of the
    Rectangle class when using keyword arguments."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Indicates that there are unit tests specifically crafted to evaluate
    the functionality of the 'to_dictionary' method within the
    Rectangle class."""
